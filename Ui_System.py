...
"margin-top: 0px;")
        ...
        # 添加保存按钮布局
        self.widget_save_buttons = QtWidgets.QWidget(self.widget_4)
        self.widget_save_buttons.setStyleSheet("border:none\n")
        self.widget_save_buttons.setObjectName("widget_save_buttons")
        self.verticalLayout_save = QtWidgets.QVBoxLayout(self.widget_save_buttons)
        self.verticalLayout_save.setContentsMargins(0, 7, 0, 0)
        self.verticalLayout_save.setSpacing(7)
        self.verticalLayout_save.setObjectName("verticalLayout_save")
        
        # 开始保存按钮
        self.button_start_save = QtWidgets.QPushButton(self.widget_save_buttons)
        self.button_start_save.setStyleSheet("background-color: #f4f4f4;\ncolor: black;\n   \npadding: 5px 10px;\n\nborder-left:0px;\nborder-top:0px;\n border-right: 2px solid #a3a3a3;  /* 右边边框 */\n    border-bottom: 2px solid #a3a3a3; /* 下边边框 */\nmargin-top: 0px;")
        self.button_start_save.setObjectName("button_start_save")
        self.verticalLayout_save.addWidget(self.button_start_save)
        
        # 结束保存按钮
        self.button_stop_save = QtWidgets.QPushButton(self.widget_save_buttons)
        self.button_stop_save.setStyleSheet("background-color: #f4f4f4;\ncolor: black;\n   \npadding: 5px 10px;\n\nborder-left:0px;\nborder-top:0px;\n border-right: 2px solid #a3a3a3;  /* 右边边框 */\n    border-bottom: 2px solid #a3a3a3; /* 下边边框 */\nmargin-top: 0px;")
        self.button_stop_save.setObjectName("button_stop_save")
        self.verticalLayout_save.addWidget(self.button_stop_save)
        
        self.horizontalLayout.addWidget(self.widget_save_buttons)
...
"")
        ...
        self.verticalLayout_3.setContentsMargins(-1, 15, -1, 10)
...
"border: 0px ;      /* 边框粗细+颜色 */")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_start_save.setText(_translate("MainWindow", "开始保存"))
        self.button_stop_save.setText(_translate("MainWindow", "结束保存"))
